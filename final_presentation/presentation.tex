...
\author{Stephan Jahn} %TODO: on DPG: include Fred and Christoph
...
% TODO: write theory approaches, in particular write formula of angular observables

    {\large\textbf{theory approach:}}
...
\slide[c]{
    ...
    \begin{columns}[t]
        \column{.165\textwidth} % Left column and width
            CDF 2012:
        \column{.835\textwidth} % Left column and width
