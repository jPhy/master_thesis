...
% TODO: this is a big jump --> transition should be smooted
...
\subsection{Constraints on $\mathcal{C}_{10} ^{(\prime)} , \mathcal{C}_S ^{(\prime)} , \mathcal{C}_P ^{(\prime)} , \mathcal{C}_T , \mathrm{and} ~~ \mathcal{C}_{T5}$ }
