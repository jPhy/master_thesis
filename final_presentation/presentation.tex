...
\slide{
    ...
    {\large\textbf{Inappropriate form factor uncertainty?}} % TODO: reformulate

    \begin{center}
        \includegraphics[width=0.7\textwidth]{figures/Wilson_coeff_2d} %TODO: put form factor plot ( f_T(0) ) here
    \end{center}
...
\slide{
    ...
    {\large\textbf{Large $\boldsymbol{1/m_b}$ corrections to QCDF?}} % TODO: reformulate
