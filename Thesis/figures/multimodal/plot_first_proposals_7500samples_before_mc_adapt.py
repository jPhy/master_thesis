...
plt.xlabel('$x_1$')
plt.ylabel('$x_2$')
plt.savefig('plain_mc_data_7500.png') # not .svg because there too many hexagon objects --> rendering takes too long
...
plt.xlabel('$x_1$')
plt.ylabel('$x_2$')
plt.savefig('first_prop_vb_7500.pdf')
...
plt.xlabel('$x_1$')
plt.ylabel('$x_2$')
plt.savefig('first_prop_hc_7500.pdf')
