...
if type(first_proposal_index) is int:
    ...
    if first_proposal_index == 'good_original':
        ...
        if dim == 2:
            ...
            first_proposal = load_first_proposal(26)
        elif dim == 20:
            first_proposal = load_first_proposal(47)
        else:
            raise NotImplementedError('No such first proposal')

    elif first_proposal_index == 'good_variational':
        if dim == 2:
            first_proposal = load_first_proposal(99)
        elif dim == 10:
            first_proposal = load_first_proposal(103)
        elif dim == 20:
            first_proposal = load_first_proposal(104)
        else:
            raise NotImplementedError('No such first proposal')

    elif first_proposal_index == 'average_variational':
        if dim == 2:
            first_proposal = load_first_proposal(97)
        elif dim == 10:
            first_proposal = load_first_proposal(101)
        elif dim == 20:
            first_proposal = load_first_proposal(106)
        else:
            raise NotImplementedError('No such first proposal')
